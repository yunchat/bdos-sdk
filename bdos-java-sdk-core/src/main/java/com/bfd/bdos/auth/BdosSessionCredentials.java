 ...
 */
public class BdosSessionCredentials extends BasicSessionCredentials {
    ...
    public BdosSessionCredentials(String accessKeyId, String accessKeySecret,
                                      String sessionToken, String refreshToken,  long expiration, long roleSessionDurationSeconds) {
        super(accessKeyId, accessKeySecret, sessionToken, refreshToken, roleSessionDurationSeconds);
//
...
//            throw new IllegalArgumentException("Failed to get valid expiration time from Auth service.");
//        }
