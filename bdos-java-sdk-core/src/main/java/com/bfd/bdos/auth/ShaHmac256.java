...
import com.bfd.bdos.utils.Base64Helper;
    ...
    public String signString(String source, String accessSecret)
        ...
        try {
            ...
            mac.init(new SecretKeySpec(
                accessSecret.getBytes(BaseURLEncoder.URL_ENCODING), AGLORITHM_NAME));
            byte[] signData = mac.doFinal(source.getBytes(BaseURLEncoder.URL_ENCODING));
